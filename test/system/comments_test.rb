...
class CommentsTest < ApplicationSystemTestCase
  ...
  test "all the comment tests" do
    #### "visiting the index" do
    log_user_in(:admin_user_1, :one)
    visit comments_url
    assert_selector "h1", text: "Comments"
    #end

    #### "visiting the edit page" do
    #log_user_in(:admin_user_1, :one)
    visit comments_url
    ...
    ####test "all the destructive tests" do
    #log_user_in(:admin_user_1, :one)
    ...
    #### linking comment to suggested change"
    ...
    # logged out user can't visit index
    log_user_out
    visit comments_url
